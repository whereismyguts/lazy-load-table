...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget1.setMaximumSize(QtCore.QSize(16777215, 26))
        ...
        self.connectionStringLineEdit = QtWidgets.QLineEdit(self.widget1)
        ...
        self.openBtn = QtWidgets.QPushButton(self.widget1)
        self.openBtn.setObjectName("openBtn")
        self.horizontalLayout.addWidget(self.openBtn)
        self.executeBtn = QtWidgets.QPushButton(self.widget1)
